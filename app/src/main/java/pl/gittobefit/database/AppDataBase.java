 ...
 * klasa bazy danych
 */
@Database(entities = {UserEntity.class, WorkoutForm.class, Exercise.class, SavedTraining.class, EquipmentType.class, Equipment.class}, version =1, exportSchema = false)
