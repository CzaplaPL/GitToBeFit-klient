                    ...
                    call2.enqueue(new Callback<Void>()
                    {
                        ...
                        public void onResponse(Call<Void> call2, Response<Void> response2) {
                            if (response2.isSuccessful()) {
                                User.getInstance().add(email, password, response.headers().get("Authorization"), "1", User.WayOfLogin.OUR_SERVER, main.getApplicationContext());
                                main.loginSuccess();
                            } else {
        ...
        call.enqueue(new Callback<Void>()
        {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()) {
                    ...
                    User.getInstance().add("email", response.headers().get("Authorization"), "1", User.WayOfLogin.FACEBOOK, main.getApplicationContext());
                    main.loginSuccess();
                } else {
                    if (response.code() != 400) {
